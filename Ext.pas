...
// Generated by ExtToPascal v.0.9.8, at 20/1/2010 14:59:50
...
type
  ...
  public
    ...
    function GetViewSize(ContentBox : Boolean) : TExtFunction;
  ...
  public
    ...
    function CanLayout : TExtFunction;
...
function TExtDomQuerySingleton.Select(Selector : String; Root : TExtDataNode = nil) : TExtFunction; begin
  JSCode(JSName + '.select(' + VarToJSON([Selector, Root, false]) + ');', 'TExtDomQuerySingleton');
  Result := Self;
end;
...
function TExtElement.GetViewSize(ContentBox : Boolean) : TExtFunction; begin
  JSCode(JSName + '.getViewSize(' + VarToJSON([ContentBox]) + ');', 'TExtElement');
  Result := Self;
end;
...
function TExtElement.HandleError(E : TExtObject) : TExtFunction; begin
  JSCode(JSName + '.handleError(' + VarToJSON([E, false]) + ');', 'TExtElement');
  Result := Self;
end;

function TExtElement.HandleError(E : TExtError) : TExtFunction; begin
  JSCode(JSName + '.handleError(' + VarToJSON([E, false]) + ');', 'TExtElement');
  Result := Self;
end;
...
function TExtElement.Select(Selector : String; Unique : Boolean = false) : TExtFunction; begin
  JSCode(JSName + '.select(' + VarToJSON([Selector, Unique]) + ');', 'TExtElement');
  Result := Self;
end;
...
function TExtContainer.CanLayout : TExtFunction; begin
  JSCode(JSName + '.canLayout();', 'TExtContainer');
  Result := Self;
end;
...
procedure TExtButton.SetFRowspan(Value : Integer); begin
  FRowspan := Value;
...
procedure TExtTabPanel.SetFMonitorResize(Value : Boolean); begin
  FMonitorResize := Value;
  JSCode('monitorResize:' + VarToJSON([Value]));
end;
