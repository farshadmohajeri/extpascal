...
const
  // Productions id
  Start       = #128; ProgramParams = #129; IdentList  = #130; UsesClause   = #131; Filler      = #132;
  ...
  FileOf      = #188; ForStmt       = #189; PropParams = #190; Directives   = #191;
...
// DeclSection
  ...
  '|EXPORTS|'     + Ident + IdentList + DeclSection, // COMPLETAR ...
// VarDecl
