// Generated by GenPkg 0.0.8 at 11:52:30 on 2010-03-13
...
function TExtFormComboBox_Grid.GetStoreArray : TStrings;
begin
  Result := Items;
end;

procedure TExtFormComboBox_Grid.SetStoreArray(AStoreArray : TStrings);
begin
