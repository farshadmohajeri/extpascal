...
type
  ...
  public
    ...
    function Realize(RecordJS : TExtObjectList; Data : TExtObjectList) : TExtFunction;
    function Update(Rs : TExtObjectList; Data : TExtObjectList) : TExtFunction;
  ...
  public
    ...
    function Apply(Params : TExtObject; BaseParams : TExtObject; Action : string; Rs : TExtObjectList) : TExtFunction;
  ...
  TExtDataStoreOnBeforewrite = procedure(Store : TExtDataStore; Action : string; Rs : TExtObjectList; Options : TExtObject; Arg : TExtObject) of object;
  ...
  TExtDataStoreOnWrite = procedure(Store : TExtDataStore; Action : string; ResultJS : TExtObject; Res : TExtDirectTransaction; Rs : TExtObjectList) of object;
  ...
  public
    ...
    function Remove(RecordJS : TExtObjectList) : TExtFunction;
  ...
  public
    ...
    function CreateRecord(Rec : TExtDataRecord) : TExtFunction;
    function DestroyRecord(Rec : TExtDataRecord) : TExtFunction;
    function Render(Params : TExtObject; BaseParams : TExtObject; Data : TExtObjectList) : TExtFunction;
    function UpdateRecord(Rec : TExtDataRecord) : TExtFunction;
    destructor Destroy; override;
  ...
  TExtDataDataProxyOnBeforewrite = procedure(This : TExtDataDataProxy; Action : string; Rs : TExtObjectList; Params : TExtObject) of object;
  ...
  public
    ...
    function DoRequest(Action : string; Rs : TExtObjectList; Params : TExtObject; Reader : TExtDataDataReader; Callback : TExtFunction; Scope : TExtObject; Arg : TExtObject) : TExtFunction;
  ...
  public
    ...
    function OnWrite(Action : string; Trans : TExtObject; ResultJS : TExtObject; Res : TExtObject; Rs : TExtObjectList) : TExtFunction;
    destructor Destroy; override;
...
procedure TExtDataJsonWriter.SetFReturnJson(Value : Boolean); begin
  FReturnJson := Value;
  JSCode('returnJson:' + VarToJSON([Value]));
end;
...
procedure TExtDataStore.HandleEvent(const AEvtName : string); begin
  ...
  if (AEvtName = 'add') and Assigned(FOnAdd) then
    ...
    FOnBeforewrite(TExtDataStore(ParamAsObject('Store')), ParamAsstring('Action'), TExtObjectList(ParamAsObject('Rs')), TExtObject(ParamAsObject('Options')), TExtObject(ParamAsObject('Arg')))
    ...
    FOnWrite(TExtDataStore(ParamAsObject('Store')), ParamAsstring('Action'), TExtObject(ParamAsObject('ResultJS')), TExtDirectTransaction(ParamAsObject('Res')), TExtObjectList(ParamAsObject('Rs')));
end;
...
procedure TExtDataDataProxy.HandleEvent(const AEvtName : string); begin
  ...
  if (AEvtName = 'beforeload') and Assigned(FOnBeforeload) then
    ...
    FOnBeforewrite(TExtDataDataProxy(ParamAsObject('This')), ParamAsstring('Action'), TExtObjectList(ParamAsObject('Rs')), TExtObject(ParamAsObject('Params')))
  else if (AEvtName = 'exception') and Assigned(FOnException) then
