// Generated by GenPkg 0.0.8 at 11:51:44 on 2010-03-14
...
uses
  Classes, {$IFDEF LCL} LResources, {$ENDIF} Graphics, Controls, StdCtrls, ExtCtrls, ComCtrls, Forms;
...
{$ENDIF}
  ...
  protected
    ...
    procedure SetBackgroundColor(ABackgroundColor : TColor);
    function GetDisabled : Boolean;
    procedure SetDisabled(ADisabled : Boolean);
    function GetHidden : Boolean;
    procedure SetHidden(AHidden : Boolean);
...
function TExtFormLabel.GetBackgroundColor : TColor;
begin
  Result := Color;
end;

procedure TExtFormLabel.SetBackgroundColor(ABackgroundColor : TColor);
begin
  if Color <> ABackgroundColor then
