...
version: 0.8.7, Beta 2 release, 14-jun-2008

ExtPascal is an another Ext JS wrapper. 
...
Site: http://extpascal.googlecode.com
Getting Started: http://code.google.com/p/extpascal/wiki/GettingStarted
Live demos: http://pitinnu.com/cgi-bin/extpascalsamples
Forum: http://groups.google.com/group/extpascal
License: LGPL

Changes since last release

- Self-translating bug fixes
- Ajax parameters using ExtObjects
- "T" prefix in generated classes
- FPC incompatibilites