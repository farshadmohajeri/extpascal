...
// Generated by ExtToPascal v.0.9.8, at 19/4/2010 12:11:23
...
type
  ...
  public
    ...
    function CreateMultipleFilterFn(Filters : TExtObjectList) : TExtFunction;
    function CreateSortFunction(Field : String; Direction : String) : TExtFunction;
    function DestroyJS : TExtFunction; override;
...
function TExtDataStore.CreateMultipleFilterFn(Filters : TExtObjectList) : TExtFunction; begin
  JSCode(JSName + '.createMultipleFilterFn(' + VarToJSON(Filters) + ');', 'TExtDataStore');
  Result := Self;
end;

function TExtDataStore.CreateSortFunction(Field : String; Direction : String) : TExtFunction; begin
  JSCode(JSName + '.createSortFunction(' + VarToJSON([Field, Direction]) + ');', 'TExtDataStore');
  Result := Self;
end;
