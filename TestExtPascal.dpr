...
uses
  ExtPascal, Ext, ExtGlobal, ExtData, ExtForm, ExtGrid,
...
type
  TTestExtPascal = class(TFCGIThread)
    ...
    procedure ProcessMessage(Message : string); override;
  end;

procedure TTestExtPascal.ProcessMessage(Message : string); begin
